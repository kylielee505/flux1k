...
class UNETLoader:
    ...
    def load_unet(self, unet_name):
        ...
        model = totoro.sd.load_unet(unet_path)
        return (model,)
...
class DualCLIPLoader:
    ...
    def load_clip(self, clip_name1, clip_name2):
        ...
        clip = totoro.sd.load_clip(ckpt_paths=[clip_path1, clip_path2], embedding_directory=folder_paths.get_folder_paths("embeddings"))
        return (clip,)
