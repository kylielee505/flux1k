...
class T5XXLModel(sd1_clip.SDClipModel):
    def __init__(self, device="cpu", layer="last", layer_idx=None, dtype=None):
        ...
        super().__init__(device=device, layer=layer, layer_idx=layer_idx, textmodel_json_config=textmodel_json_config, dtype=dtype, special_tokens={"end": 1, "pad": 0}, model_class=totoro.t5.T5)
...
class SD3ClipModel(torch.nn.Module):
    def __init__(self, clip_l=True, clip_g=True, t5=True, dtype_t5=None, device="cpu", dtype=None):
        ...
        if t5:
            if dtype_t5 is None:
                dtype_t5 = dtype
            elif totoro.model_management.dtype_size(dtype_t5) > totoro.model_management.dtype_size(dtype):
                dtype_t5 = dtype

            if not totoro.model_management.supports_cast(device, dtype_t5):
                dtype_t5 = dtype
